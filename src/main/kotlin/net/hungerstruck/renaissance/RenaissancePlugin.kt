...
import net.hungerstruck.renaissance.commands.*
...
class RenaissancePlugin : JavaPlugin() {
    ...
    override fun onEnable() {
        ...
        cmdRegister.register(FSpecCommands::class.java)
        cmdRegister.register(LobbyCommands::class.java)
        cmdRegister.register(GVentCommands::class.java)
    }
    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        ...
        try {
            ...
            if (cause is NumberFormatException) {
                ...
                sender.sendMessage(ChatColor.RED.toString() + "We're sorry, but some unexpected error occurred. Please check console")
                e.printStackTrace()
            }
